                ...
                <div class="card border-0">
                    <div class="card-body p-0">
                        ...
                        <div class="d-flex">
                            ...
                            @else
                                <button class="mx-auto btn btn-sm btn-outline-success" data-toggle="modal" data-target="#ConfirmOrderModal">Pay !</button>
                                <!-- Modal -->
                                <div class="modal fade" id="ConfirmOrderModal" tabindex="-1" role="dialog" aria-labelledby="ConfirmOrderModalTitle" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        ...
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="ConfirmOrderModalTitle">Payment Confirmation</h5>
