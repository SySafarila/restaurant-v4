            ...
            @foreach ($menus as $menu)
                <div class="col-6 px-1 col-md-2 mb-2">
                    <div class="card h-100 shadow-sm" id="{{ $menu->id }}">
                        <div style="background-image: url('{{ asset('storage/menuImages/' . $menu->images->first()->name) }}'); height:140px; width:100%; background-size: cover; background-repeat: no-repeat; background-position: center;"></div>
