                                    ...
                                    @foreach ($orders as $order)
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                {{ $order->menu->name }} <a href="{{ route('orders.edit', $order->id) }}" class="badge badge-success">Edit</a> <a class="text-decoration-none badge badge-danger align-middle" href="{{ route('orders.destroyOne', $order->id) }}" onclick="event.preventDefault(); document.getElementById('orders.destroyOne').submit();">{{ __('Delete') }}</a>
